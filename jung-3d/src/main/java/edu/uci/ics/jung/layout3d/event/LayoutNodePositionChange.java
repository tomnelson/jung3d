...
public interface LayoutNodePositionChange {
  ...
  interface Support<N> {
    ...
    void addLayoutNodePositionChangeListener(
        edu.uci.ics.jung.layout3d.event.LayoutNodePositionChange.Listener<N> l);

    void removeLayoutNodePositionChangeListener(
        edu.uci.ics.jung.layout3d.event.LayoutNodePositionChange.Listener<N> l);

    List<edu.uci.ics.jung.layout3d.event.LayoutNodePositionChange.Listener<N>>
        getLayoutNodePositionChangeListeners();
  ...
  class SupportImpl<N> implements Support<N> {
    ...
    @Override
    public void addLayoutNodePositionChangeListener(
        edu.uci.ics.jung.layout3d.event.LayoutNodePositionChange.Listener l) {
      changeListeners.add(l);
    }

    @Override
    public void removeLayoutNodePositionChangeListener(
        edu.uci.ics.jung.layout3d.event.LayoutNodePositionChange.Listener l) {
      changeListeners.remove(l);
    }

    @Override
    public List<edu.uci.ics.jung.layout3d.event.LayoutNodePositionChange.Listener<N>>
        getLayoutNodePositionChangeListeners() {
