...
public interface LayoutStateChange {
  ...
  interface Support {
    ...
    void addLayoutStateChangeListener(
        edu.uci.ics.jung.layout3d.event.LayoutStateChange.Listener listener);

    void removeLayoutStateChangeListener(
        edu.uci.ics.jung.layout3d.event.LayoutStateChange.Listener listener);

    List<edu.uci.ics.jung.layout3d.event.LayoutStateChange.Listener>
  ...
  class SupportImpl implements Support {
    ...
    private static final Logger log =
        LoggerFactory.getLogger(
            edu.uci.ics.jung.layout3d.event.LayoutStateChange.SupportImpl.class);
    ...
    @Override
    public void addLayoutStateChangeListener(
        edu.uci.ics.jung.layout3d.event.LayoutStateChange.Listener l) {
      changeListeners.add(l);
    }

    @Override
    public void removeLayoutStateChangeListener(
        edu.uci.ics.jung.layout3d.event.LayoutStateChange.Listener l) {
      changeListeners.remove(l);
    }

    @Override
    public List<edu.uci.ics.jung.layout3d.event.LayoutStateChange.Listener>
        getLayoutStateChangeListeners() {
    ...
    public void fireLayoutStateChanged(LayoutModel layoutModel, boolean state) {
      if (fireEvents && changeListeners.size() > 0) {
        ...
        edu.uci.ics.jung.layout3d.event.LayoutStateChange.Event evt =
            new edu.uci.ics.jung.layout3d.event.LayoutStateChange.Event(layoutModel, state);
