...
public class EdgeGroup<E> extends TransformGroup {
  ...
  public void setEndpoints(Point p0, Point p1) {
    ...
    p0tx.setTranslation(new Vector3d(p0.x, p0.y, p0.z));
    ...
    rot.setRotation(new AxisAngle4d(cross.x, cross.y, cross.z, angle));
    tx.mul(rot);

    tx.mul(scaletx);
    tx.setTranslation(new Vector3d(p0.x, p0.y, p0.z));
